...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->alu_tb__DOT__a = VL_RAND_RESET_I(16);
    vlSelf->alu_tb__DOT__b = VL_RAND_RESET_I(16);
    vlSelf->alu_tb__DOT__control = VL_RAND_RESET_I(3);
    vlSelf->alu_tb__DOT__z = VL_RAND_RESET_I(16);
    vlSelf->alu_tb__DOT__c = VL_RAND_RESET_I(2);
    }
