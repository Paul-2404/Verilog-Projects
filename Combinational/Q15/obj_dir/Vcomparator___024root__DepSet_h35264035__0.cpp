...
void Vcomparator___024root___eval_initial(Vcomparator___024root* vlSelf) {
    ...
    // Body
    Vcomparator___024root___eval_initial__TOP(vlSelf);
...
VL_INLINE_OPT VlCoroutine Vcomparator___024root___eval_initial__TOP__Vtiming__0(Vcomparator___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.comparator_tb__DOT__a = 0xdU;
    vlSelfRef.comparator_tb__DOT__b = 0xdU;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "comparator_tb.v", 
                                         16);
    vlSelfRef.comparator_tb__DOT__a = 0xe0U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "comparator_tb.v", 
                                         19);
    vlSelfRef.comparator_tb__DOT__b = 0xfcU;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "comparator_tb.v", 
                                         23);
    VL_FINISH_MT("comparator_tb.v", 23, "");
}
...
#endif
            VL_FATAL_MT("comparator_tb.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("comparator_tb.v", 1, "", "Active region did not converge.");
            }
