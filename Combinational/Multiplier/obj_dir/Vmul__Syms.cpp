...
void Vmul__Syms::_traceDump() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
    __Vm_dumperp->dump(VL_TIME_Q());
}

void Vmul__Syms::_traceDumpOpen() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
...
void Vmul__Syms::_traceDumpClose() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
    __Vm_dumping = false;
    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    // Setup scopes
    __Vscope_mul_tb.configure(this, name(), "mul_tb", "mul_tb", -12, VerilatedScope::SCOPE_OTHER);
}
