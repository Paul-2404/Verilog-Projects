...
#endif
            VL_FATAL_MT("mul_tb.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vmul___024root___dump_triggers__act(Vmul___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([changed] mul_tb.a)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] mul_tb.b)\n");
    }
    if ((4ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] mul_tb.p)\n");
    }
...
VL_ATTR_COLD void Vmul___024root___dump_triggers__nba(Vmul___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([changed] mul_tb.a)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] mul_tb.b)\n");
    }
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] mul_tb.p)\n");
    }
...
VL_ATTR_COLD void Vmul___024root___ctor_var_reset(Vmul___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->mul_tb__DOT__a = VL_RAND_RESET_I(16);
    vlSelf->mul_tb__DOT__b = VL_RAND_RESET_I(16);
    vlSelf->mul_tb__DOT__p = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigprevexpr___TOP__mul_tb__DOT__a__0 = VL_RAND_RESET_I(16);
    vlSelf->__Vtrigprevexpr___TOP__mul_tb__DOT__b__0 = VL_RAND_RESET_I(16);
    vlSelf->__Vtrigprevexpr___TOP__mul_tb__DOT__p__0 = VL_RAND_RESET_I(32);
