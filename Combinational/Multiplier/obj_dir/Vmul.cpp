...
void Vmul::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vmul::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
//============================================================
// Events and timing
bool Vmul::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vmul::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }
