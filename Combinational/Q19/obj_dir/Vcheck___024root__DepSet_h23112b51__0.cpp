...
VlCoroutine Vcheck___024root___eval_initial__TOP__Vtiming__0(Vcheck___024root* vlSelf);
...
void Vcheck___024root___eval_initial(Vcheck___024root* vlSelf) {
    ...
    // Body
    Vcheck___024root___eval_initial__TOP__Vtiming__0(vlSelf);
}
...
void Vcheck___024root___timing_resume(Vcheck___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcheck__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcheck___024root___timing_resume\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
bool Vcheck___024root___eval_phase__act(Vcheck___024root* vlSelf) {
    ...
    if (__VactExecute) {
        ...
        Vcheck___024root___timing_resume(vlSelf);
...
#endif
            VL_FATAL_MT("check_tb.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("check_tb.v", 1, "", "Active region did not converge.");
            }
