...
void Vcequ_ops___024root__trace_chg_0_sub_0(Vcequ_ops___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vcequ_ops___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcequ_ops___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vcequ_ops___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vcequ_ops___024root__trace_chg_0_sub_0(Vcequ_ops___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcequ_ops__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcequ_ops___024root__trace_chg_0_sub_0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    bufp->chgCData(oldp+0,(((IData)(vlSelfRef.cequ_ops_tb__DOT__a__strong__out0) 
                            | ((0xeU & (IData)(vlSelfRef.cequ_ops_tb__DOT__a__strong__out1)) 
                               | (IData)(vlSelfRef.cequ_ops_tb__DOT__a__strong__out2)))),4);
    bufp->chgCData(oldp+1,(((IData)(vlSelfRef.cequ_ops_tb__DOT__b__strong__out3) 
                            | (0xeU & (IData)(vlSelfRef.cequ_ops_tb__DOT__b__strong__out4)))),4);
    bufp->chgBit(oldp+2,((((IData)(vlSelfRef.cequ_ops_tb__DOT__a__strong__out0) 
                           | ((0xeU & (IData)(vlSelfRef.cequ_ops_tb__DOT__a__strong__out1)) 
...
void Vcequ_ops___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcequ_ops___024root__trace_cleanup\n"); );
    // Init
    Vcequ_ops___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vcequ_ops___024root*>(voidSelf);
    Vcequ_ops__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
