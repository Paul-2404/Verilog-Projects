...
void Vcounter___024root__trace_chg_0_sub_0(Vcounter___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelfRef.counter_tb__DOT__clk));
    bufp->chgBit(oldp+1,(vlSelfRef.counter_tb__DOT__rst));
    bufp->chgBit(oldp+2,(vlSelfRef.counter_tb__DOT__O));
    bufp->chgIData(oldp+3,(vlSelfRef.counter_tb__DOT__c),32);
}
